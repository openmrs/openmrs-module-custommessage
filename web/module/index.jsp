...
<table style="width:100%;">
	<tr>
		<td style="width:25%;" valign="top">
			<table id="codeList" style="border:1px solid #8FABC7;">
		...
		<td style="width:75%; padding-left:25px; padding-top:25px;" valign="top">
			...
			<span id="codeSelectedSection" style="display:none;">
				...
				<div class="box">
					<table cellpadding="5" style="padding:10px; width:100%;">
						<c:forEach items="${supportedLocales}" var="localeEntry">
							...
							<tr>
								...
								<td valign="top" style="width:100%; padding-bottom:20px;">
									...
									<textarea class="customMessageInput" id="customMessage${localeEntry.value}" rows="3" style="width:100%;"></textarea>
								</td>
							</tr>
						</c:forEach>
					</table>
